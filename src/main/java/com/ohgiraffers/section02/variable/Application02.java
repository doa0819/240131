...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        *   이러한 기본자료형(primary type)과 참조자료형(Reference)으로 나누어진다
        *   그 중 기본자료형 8가지부터 살펴보자.*/
        ...
        snum = 2;
        inum = 4;
        lnum = 8L;      // 아무 문제없는 것 같지만 사실 뒤에 대문자 L을 붙여야 한다.  그 이유는 뒤에 형변환에 다루게 될 것이다. (L 대문자로 쓰는 이우는 소문자는 1이랑 헷갈리수 있기 때문에 암묵적 룰)


        /* 목차. 2-2. 실수를 취급하는 자료형애 값 대입 */
        fnum = 4.0f;    // 실수 형태의 값을 fnum(f는 소문자로 쓰는게 암묵적 룰)
        dnum = 8.0;

        /* 목차. 2-3. 문자를 취급하는 자료형에 값 대입*/
        ch = 'a';
        ch = 97;    // 'a'는 97 은 숫자열지? 그래서 숫자로도 저장할 수 있다.
