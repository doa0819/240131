...
public class Application03 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 필기.
        *   변수의 명명 규칙
        *   1. 컴파일 에러를 발생시키는 규칙(컴파일: 오류명령하는 코드)
        *     1-1, 동일한 범위 내에서 동일한 변수명을 가질 수 없다.
        *     1-2, 예약어는 사용이 불가능 하다. (예약어: 미리작성된 언어 - 규칙된 언어)
        ...
        *     2-1. 변수명의 같이 제한은 없다.(하지만 적당히 해야겠죠?)
...
//      int age = 20;
 ...
 //       int @adad = 20;
        ...
        int szkjdfnsakjedfhnjsdkjhfoadsgjhagsdjhagsdkjagsdjagsdkju;

        /*목차. 2-2. 변수명이 합성어로 이루러진 경우 첫 단어는 소문자, 두 번째 시작 단어는 대문자로 시작한다. */
       ...
       int 나이;
        ...
        /* 목차. 2-5. 변수 안에 저장돤 값이 어떤 의미를 가지는 지 명확하게 표현하도록 한다. */
        String s;
